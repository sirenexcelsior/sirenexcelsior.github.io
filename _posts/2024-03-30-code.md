...
Example: BX = $$ 032E_{16} $$, result AX = $$ 03__{16} + 2E__{16}$$ = $$31_{16} $$.
...
?01: 
INC AX              ; Increment AX (could be part of a different operation or counter)
MOV BX, [1]         ; Restore BX from memory location addressed by 1
INC BX              ; Increment BX
JMP ?00             ; Jump back to start of loop at label ?00
...
![BusProg](https://github.com/sirenexcelsior/sirenexcelsior.github.io/blob/master/assets/img/AL02-15.png)
